...
<div class="cryptocurrency_converter">
    <?php
    /** @var TYPE_NAME $converter_currency_data */
    if (is_array($converter_currency_data) and count($converter_currency_data) > 1) : ?>
    <div class="convert-component" >
        <input type="hidden" class="rate-value-left" data-currency="<?php echo $converter_currency_data[0]->cur_symbol?>" id="left-rate" value="<?php echo $converter_currency_data[0]->usd?>">
        <input type="hidden" class="rate-value-right" data-currency="<?php echo $converter_currency_data[1]->cur_symbol?>" id="right-rate" value="<?php echo $converter_currency_data[1]->usd?>">
            ...
            <div class="convert-component__input-group">
                <div class="convert-component__form-group convert-component__form-group--left">
                    <div class="convert-component__input-box">
                        <input class="convert-component__form-control" type="text" name="amount" placeholder="1" value="1">
                    </div>
                    <div class="convert-component__dropdown-box">
                        <div class="convert-component__dropdown">
                            <select class="left-list" sort="right-list">
                                ...
                                <option value="<?php echo $currency->cur_symbol?>"><?php echo $currency->cur_symbol?> <span>- <?php echo $currency->cur_name?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="convert-component__dropdown">
                            <select class="right-list" sort="right-list">
                                <?php foreach ($converter_currency_data as $k=>$currency):?>
                                    <option value="<?php echo $currency->cur_symbol?>" <?php echo ($k==1) ? 'selected' : ''?>><?php echo $currency->cur_symbol?> <span>- <?php echo $currency->cur_name?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
    ...
    <div class="recently-converted">
        ...
        <div class="recently-converted__data">
            <?php
            /** @var TYPE_NAME $converter_log_data */
            ...
            <ul class="recently-converted__column">
                ...
                <li>
                    <div class="recently-converted__convert-description">
                        <?= $log_data->convert_value?> <?=$log_data->convert_from?> to <?=$log_data->convert_to?>
                    </div>
